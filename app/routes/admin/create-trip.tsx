...
const CreateTrip = ({loaderData}: Route.ComponentProps) => {
  ...
  return (
    <main className="flex flex-col gap-10 pb-20 wrapper">
        <Header title="Add a New Trip" description="Create new AI-generated travel plans"/>
            ...
            <form className="trip-form" onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <input 
                        ...
                        type="number"
                        name="duration"
                        placeholder="Ender a number of days (5, 12, ...)"
                ...
                <footer className="px-6 w-full">
                    <ButtonComponent type="submit" className="button-class !h-12 !w-full" disabled={loading}>
                        ...
                        <span className="p-16-semibolod text-white">
